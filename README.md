...
Usage of oauth2_proxy:
  ...
  -pass-basic-auth: pass HTTP Basic Auth, X-Forwarded-User, X-Forwarded-Group and X-Forwarded-Email information to upstream (default true)
  -pass-host-header: pass the request Host Header to upstream (default true)
  -pass-user-headers: pass X-Forwarded-User, X-Forwarded-Group and X-Forwarded-Email information to upstream (default true)
